...
- Failure recovery and rollback fixtures
- Cross-check examples, templates, schemas, and workflows
- Generate conformance coverage report

## Then: Phase 4

- Documentation site and navigation
- Community contribution workflows
- Release-candidate audit
- v1.0.0 public release

The project will not add new core skills before integrated conformance is complete.
